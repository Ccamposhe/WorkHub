...
public class WorkspaceMemberController {
    ...
    public ResponseEntity<List<WorkspaceMember>> listMyWorkspaces(@RequestHeader("user-id") UUID userId){
        List<WorkspaceMember> myWorkspaces = service.listMyWorkspaces(userId);
